...
variable "org" {
  type        = "string"
  description = "Your IBM Cloud ORG"
}

variable "space" {
  type        = "string"
  description = "Your IBM Cloud Space"
}
  ...
  /*
        "options": [
          ...
          },
          {
            ...
            "label": "Generate documents from any standard data source with the Document Generation for IBM Cloud service."
          },
          {
          ...
          },
          {
            ...
            "label": "Automated Integration Testing for IBM Cloud"
          },
          {
          ...
          },
          {
            ...
            "label": "Allows you to quickly get up and running on a pre-configured WebSphere Application Server installation in a hosted cloud environment on IBM Cloud."
          },
          {
            "value": "WorkloadScheduler",
            "label": "Automate your tasks to run one time or on recurring schedules. Far beyond Cron, exploit job scheduling within and outside IBM Cloud."
          },
          {
            "value": "XPagesData",
          ...
          {
            "value": "accessTrail",
            "label": "Capture, store, and visualize your IBM Cloud cloud activities"
          },
          {
          ...
          {
            "value": "apiHarmony",
            "label": "IBM API Harmony for IBM Cloud supports developers in identifying and selecting APIs."
          },
          {
            "value": "apprenda",
            "label": "IBM Cloud .NET Powered by Apprenda"
          },
          {
            "value": "attm2x",
          ...
          },
          {
            ...
            "label": "IBM Compose Enterprise is a service which provides a private isolated cluster for IBM Cloud users to optionally provision their Compose databases into."
          },
          {
          ...
          {
            "value": "cpy-insights",
            "label": "Business Activity Insights for IBM Cloud apps"
          },
          {
            "value": "dashDB",
          ...
          },
          {
            ...
            "label": "Utilize IBM's Blockchain Technology within IBM Cloud"
          },
          {
          ...
          },
          {
            ...
            "label": "Mobile app developers and business stakeholders: Use IBM Mobile Analytics for IBM Cloud to gain insight into how your app is performing and how it is being used."
          },
          {
          ...
          {
            "value": "spark",
            "label": "IBM Analytics for Apache Spark for IBM Cloud."
          },
          {
          ...
          },
          {
            ...
            "label": "Use the Weather Company Data for IBM IBM Cloud service to incorporate weather data into your IBM Cloud applications."
          },
          {
